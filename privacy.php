...
<title>プライバシーポリシー | LONG KEEP SKIN MAKE</title>
...
<body>
    <?php
    require_once('subpage_nav.php');
    ?>
    <div class="container pb-5 privacy">
        <div class="row justify-content-center pb-md-5 mb-md-5">
            <div class="col-12 col-md-9 pb-5">
                <div class="mb-5 mx-3">
                    <h2 class="my-5">Privacy Policy<span>プライバシーポリシー</span></h2>
                    ...
                    <ol>
                        ...
                        <li>
                            当ショップは、当ショップサービスが提供するサービスの利用状況等を調査・分析するため、本サービス上に Google LLCが提供する Google アナリティクスを利用しています。Googleアナリティクスでデータが収集、処理される仕組みその他Googleアナリティクスの詳しい情報につきましては、同社のサイトをご覧ください。
                            <div class="mt-4">
                                <div class="card p-2 p-md-4 mb-5">
                                    <div class="card-body">
                                        <p class="card-text">
                                        <div>Google アナリティクス 利用規約：</div>
                                        <a href="https://www.google.com/analytics/terms/jp.html" target="_blank">https://www.google.com/analytics/terms/jp.html</a><br>
                                        <div class="pt-3">お客様が Google パートナーのサイトやアプリを使用する際の Google によるデータ使用：</div>
                                        ...
                                        <div class="pt-3">Google プライバシーポリシー：</div>
                                        <a href="http://www.google.com/intl/ja/policies/privacy/" target="_blank">http://www.google.com/intl/ja/policies/privacy/</a>
                                        <div class="pt-3">
                                            なお、お客様はご自身のデータが Google アナリティクスで使用されることを望まない場合は、Google 社の提供する Google アナリティクス オプトアウト アドオンをご利用ください。<br>
                                        </div>
                                        <div class="pt-3">Google アナリティクス オプトアウト アドオン：</div>
                        ...
                        <li>
                            本サービスでは「Google Analyticsの広告向けの機能」を有効にしており、下記の機能を利用し、広告やサイト改善のためDoubleClick CookieなどのサードパーティCookieを利用しています。
                            <div class="mt-4">
                                <div class="card p-2 p-md-4 mb-5">
                                    <div class="card-body">
                                        <h5>
